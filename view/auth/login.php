          ...
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center ">
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                <h2 class="mb-1 fs-7 fw-bolder">Merekrutmu</h2>
                <p class="mb-7">Selamat datang</p>
                <div class="row">
                  <div class="col-12 mb-2 mb-sm-0">
                    <a class="btn text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-8" href="javascript:void(0)" role="button">
                      <img src="../../assets/vendor/icons/icons/outline/brand-chrome.svg" alt="modernize-img" class="img-fluid me-2" width="18" height="18">
