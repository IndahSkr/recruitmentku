                  ...
                  <div class="card shadow-none border">
                    <div class="card-body">
                      <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="justify-content-center btn mb-1 btn-ronded btn-outline-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#modalEditIntro" onclick="openEditIntro('<?php echo $uid ?>','<?php echo $hslProfileId['intro'] ?>')">
